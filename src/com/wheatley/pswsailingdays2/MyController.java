...
public class MyController {
	...
	public static void save() {
		...
		SharedPreferences sp = c.getSharedPreferences("SailingDays2",
				MyView.getActivity().MODE_PRIVATE);
	...
	public static void reload() {
		...
		MyView.setWorstWeather(sp.getInt("WorstWeather",
				MyView.getWorstWeather()));
	}
